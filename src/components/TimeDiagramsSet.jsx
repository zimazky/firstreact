...
export default function TimeDiagramsSet(props) {
  ...
  React.useEffect(()=>{
    logController.setOnLoad( ()=>setTimeInterval( ti=>({...ti}) ))
		logController.addThermalSensor(2,['white','white','red'],new Date('2016.04.29')/1000, new Date('2022.11.06')/1000)
		logController.addThermalSensor(3,['white','white','red'],new Date('2018.09.14')/1000, new Date('2022.11.06')/1000)
		logController.addHydroSensor(0,['white','white','red'],new Date('2021.07.25')/1000, new Date('2022.11.06')/1000)
  },[])	
